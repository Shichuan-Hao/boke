...
![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-1.png)
...
![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-2.png)
...
![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-3.png)
...
![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-4.gif)

在修改完成后，还会打印出“线程Thread 1执行成功”这句话，如下图所示。

![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-4.png)

接下来我们按下左侧的执行按钮，就轮到 Thread 2 了，此时情景就不同了。

![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-5.png)
...
![这是一张图片](https://images.happymaya.cn/assert/java/thread/java-64-6.gif)
