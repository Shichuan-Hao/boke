---
title: ConcurrentHashMap 在 Java 7 和 8 有何不同
author:
  name: superhsc
...
在 Java 8 中，对于 ConcurrentHashMap 这个常用的工具类进行了很大的升级，对比之前 Java 7 版本在诸多方面都进行了调整和变化。不过，在 Java 7 中的 Segment 的设计思想依然具有参考和学习的价值，所以在很多情况下面试官都会问你：ConcurrentHashMap 在 Java 7 和 Java 8 中的结构分别是什么？它们有什么相同点和不同点？
...
红黑树还有一些其他的特点，比如根节点是黑色，并且红色节点不能连续。
