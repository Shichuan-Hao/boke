...
![](https://images.happymaya.cn/assert/structures/1101.png)

当某个结点没有左子树和右子树时，则直接打印结点，完成终止。由此可见，树的中序遍历完全满足递归的两个条件，因此可以通过递归实现。例如下面这棵树：

![](https://images.happymaya.cn/assert/structures/0909.png)

当采用递归实现中序遍历时，程序执行的逻辑架构如下图所示：

![](https://images.happymaya.cn/assert/structures/1103.gif)
...
![](https://images.happymaya.cn/assert/structures/1104.png)
...
![](https://images.happymaya.cn/assert/structures/1105.gif)
...
![1106](https://images.happymaya.cn/assert/structures/1106.gif)
