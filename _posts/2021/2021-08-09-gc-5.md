...
![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-01.png)
...
![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-03.png)
...
![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-04.png)
...
1. 堆信息
   ...
   ![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-05.png)
...
2. 关键信息
   ...
   ![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-06.png)

   在看这些信息的时候，一定要结合宿主服务器的监控去看。比如 GC 发生期间，CPU 会突然出现尖锋，就证明 GC 对 CPU 资源使用的有点多。但多数情况下，如果吞吐量和延迟在可接受的范围内，这些对 CPU 的超额使用是可以忍受的。

3. 交互式图表

   ![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-07.png)

   可以对有问题的区域进行放大查看，图中表示垃圾回收后的空间释放，可以看到效果是比较好的。

4. G1 的时间耗时

   ![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-08.png)
...
5. 其他
   ...
   ![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-09.png)

   下面这个是典型的内存泄漏。

   ![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-10.png)
...
![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-11.png)
...
![](https://maxpixelton.github.io/images/assert/java/jvm/jvm-09-12.png)
