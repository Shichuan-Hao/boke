...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1201.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1202.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1203.png)

上面创建了 `lagou `账号，然后把 `lagou` 加入`sudo`分组。这样 `lagou` 就有了 `sudo` 成为 `root` 的能力，如下图所示：

![this is images](https://Shichuan-hao.github.io/images/assert/os/1204.png)

接下来，设置 `lagou` 用户的初始化 `shell` 是 `bash`，如下图所示：

![this is images](https://Shichuan-hao.github.io/images/assert/os/1205.png)

这个时候如果使用命令 `su lagou` ，可以切换到 `lagou` 账号，但是会发现命令行没有了颜色。因此可以将原来用户下面的 `.bashrc` 文件拷贝到 `/home/lagou` 目录下，如下图所示：

![this is images](https://Shichuan-hao.github.io/images/assert/os/1206.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1207.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1208.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1209.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1210.png)

接下来，尝试一下免密登录，如下图所示：

![this is images](https://Shichuan-hao.github.io/images/assert/os/1211.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1212.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1213.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1214.png)

其中有一个环境变量比较重要，就是`PATH`。

![this is images](https://Shichuan-hao.github.io/images/assert/os/1215.png)
...
![this is images](https://Shichuan-hao.github.io/images/assert/os/1216.png)
...
### ~/.bashrc ~/.bash_profile, ~/.profile 和 /etc/profile 的区别是什么 ？
 ...
 ![this is images](https://Shichuan-hao.github.io/images/assert/os/thinking-1201.png)
