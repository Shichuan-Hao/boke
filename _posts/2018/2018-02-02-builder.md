...
建造者模式的通用 UML 图：
![建造者模式的通用 UML 图](https://Shichuan-hao.github.io/images/assert/design-patterns/builder.jpg)
...
![this is images](https://Shichuan-hao.github.io/images/assert/design-patterns/builder-times.jpg)
...
![JDK 类库中 Appendable 接口实现建造者模式的优秀范例](https://Shichuan-hao.github.io/images/assert/design-patterns/builder-jdk-example.jpg)那么问题来了，
